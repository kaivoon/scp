        ...
        <div class="col-md-8">
            <div class="border border-dark p-3 mb-2 bg-dark text-white">
                    <span class="border-top-0">
                        <h6>Thank For You Purchase</h6>
                        <h6>Purchase Successful</h6>
                        <h6>This is your receipt code: stEAM1784174</h6>
                        <p>*If purchase have problem, can enter this code when asking customer support</p>
                    </span>
            </div>
        </div>
        </div>     
        ...
        <footer> 
                <div style="float: left; width:80%">
                    <h2 style="font-size: 1em; color:rgb(247, 243, 243); padding-left: 2%; margin-top: 1% ;">           
                        <P> <img src="image/scplogo2.png" class="img-fluid rounded-circle" alt="" width="3%"> SCP &nbsp;   © 2019 SCP Corporation. All rights reserved. </P>
                    </h2>
