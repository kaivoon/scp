          ...
          <div class="col-md-10">
            <h1>Gift Delivery</h1>
              <div class="col-md-10 bg-dark text-white">
                  &nbsp;
                  <p>Select a friend to receive your gift.</p>
                  <p>Note: This option also sends an email message, to be sure your friend sees your gift as soon as possible.</p>
                  <div class="col-md-1"></div>
                        ...
                        <form action="{{('/payment')}}" class="needs-validation" novalidate>
                            ...
                            <div class="form-row">
                                <div class="col-md-10 mb-3">
                                    <label for="validationCustom01">Gift message</label>
                                    <div>
                                        <textarea id="validationCustom02" cols="50" rows="10" class="form-control" placeholder="Message" required></textarea>
                                    </div>
                                </div>
                            </div>
