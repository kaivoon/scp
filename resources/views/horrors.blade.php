    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <a href="{{('/index')}}" style="color: black; font-size: small;">&#8918 back to store </a>
        ...
        <!--slideshow--> 
            ...
            <div class="col-md-8">
              <strong><h3 style= "text-align: center; font-size: xx-large; color: whitesmoke; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">~ Horror Games ~</h3></strong>
              <h6 style="font-size: small; color: #969797; text-align: center;">Browse the newest, top selling and discounted Horror products on SCP Games Shop</h6>
              ...
              <div class="container">
                  ...
                  <div class="mySlides">
                    ...
                    <a href="{{('/friday')}}">
                      <img src="Horror/friday/friday1.jpg" style="width:100%">
                    </a>
                  </div>
                  ...
                  <div class="mySlides">
                    ...
                    <a href="{{('/outlast')}}">
                      <img src="Horror/outlast/outlast1.jpg" style="width:100%">
                    </a>
                  </div>
                  ...
                  <div class="mySlides">
                    ...
                    <a href="{{('/resident')}}">
                      <img src="Horror/resident/resident1.jpg" style="width:100%">
                    </a>
                  </div>
                  ...
                  <div style="margin-left: 33%;" >
                    <div class="column">
                      <img class="demo cursor" src="Horror/friday/friday1.jpg" style="width:100%" onclick="currentSlide(1)" alt="FRIDAY THE 13TH">
                    </div>
                    <div class="column">
                      <img class="demo cursor" src="Horror/outlast/outlast1.jpg" style="width:100%" onclick="currentSlide(2)" alt="OUTLAST">
                    </div>
                    <div class="column">
                      <img class="demo cursor" src="Horror/resident/resident1.jpg" style="width:100%" onclick="currentSlide(3)" alt="RESIDENT EVIL 2">
                    </div>
                  </div>
                </div>
          ...
          <script>
            ...
            <div class="col-md-3">
                ...
                <div class="border border-dark" style="background-color: #353131;">
                      <img src="Horror/friday/friday1.jpg" style="width:300px">
                  </div>  
            ...
            <div class="col-md-4">
              ...
              <p> <h6 style="font-size: small; color: #969797;"> Horror, Multiplayer, Survival</h6></p>
              <a href="{{('/friday')}}">
          ...
          <!--part2-->
            ...
            <div class="col-md-3">
                <div class="border border-dark" style="background-color: #353131; margin-top: 35px;">
                      <img src="Horror/outlast/outlast1.jpg" style="width:300px">
                  </div>  
            ...
            <div class="col-md-4">
              <div class="card" style="background-color: #353131; margin-top: 35px;" >&nbsp;
              <p style="color: blanchedalmond; font-weight: 800;">Outlast</p>
              <p> <h6 style="font-size: small; color: #969797;"> Horror, Multiplayer, Survival</h6></p>
              <a href="{{('/outlast')}}">
              <button style="background-color: #8FB4F4; font-weight: 800; margin-left: 60%; margin-top: 5%; font-size: small; width: 40%;">MORE</button>
              </a>
            ...
            <div class="col-md-3">
                <div class="border border-dark" style="background-color: #353131; margin-top: 35px;">
                      <img src="Horror/resident/resident1.jpg" style="width:300px">
                  </div>  
            ...
            <div class="col-md-4">
              <div class="card" style="background-color: #353131; margin-top: 35px;" >&nbsp;
              <p style="color: blanchedalmond; font-weight: 800;">Resident Evil 2</p>
              <p> <h6 style="font-size: small; color: #969797;"> Horror, Multiplayer, Survival</h6></p>
              <a href="{{('/resident')}}">
              <button style="background-color: #8FB4F4; font-weight: 800; margin-left: 60%; margin-top: 5%; font-size: small; width: 40%;">MORE</button>
              </a>
