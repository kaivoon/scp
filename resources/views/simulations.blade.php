    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <a href="{{url('/index')}}"style="color: black; font-size: small;">&#8918 back to store </a>
        ...
        <!--slideshow--> 
            ...
            <div class="col-md-8">
              <strong><h3 style= "text-align: center; font-size: xx-large; color: whitesmoke; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">~ Simulation Games ~</h3></strong>
              <h6 style="font-size: small; color: #969797; text-align: center;">Browse the newest, top selling and discounted Simulation products on SCP Games Shop</h6>
              ...
              <div class="container">
                  ...
                  <div class="mySlides">
                    ...
                    <a href="{{url('/farming')}}">
                      <img src="Simulation/farming/farming1.jpg" style="width:100%">
                    </a>
                  </div>
                  ...
                  <div class="mySlides">
                    ...
                    <a href="{{url('/friday')}}">
                      <img src="Simulation/friday/friday1.jpg" style="width:100%">
                    </a>
                  </div>
                  ...
                  <div class="mySlides">
                    ...
                    <a href="{{url('/planet')}}">
                      <img src="Simulation/planet/planet1.jpg" style="width:100%">
                    </a>
                  </div>
                  ...
                  <div style="margin-left: 33%;" >
                    <div class="column">
                      <img class="demo cursor" src="Simulation/farming/farming1.jpg" style="width:100%" onclick="currentSlide(1)" alt="FARMING SIMULATOR">
                    </div>
                    <div class="column">
                      <img class="demo cursor" src="Simulation/friday/friday1.jpg" style="width:100%" onclick="currentSlide(2)" alt="FRIDAY THE 13TH">
                    </div>
                    <div class="column">
                      <img class="demo cursor" src="Simulation/planet/planet1.jpg" style="width:100%" onclick="currentSlide(3)" alt="PLANET ZOO">
                    </div>
                  </div>
                </div>
          ...
          <script>
            ...
            <div class="col-md-3">
                ...
                <div class="border border-dark" style="background-color: #353131;">
                      <img src="Simulation/farming/farming1.jpg" style="width:300px">
                  </div>  
            ...
            <div class="col-md-4">
              ...
              <p> <h6 style="font-size: small; color: #969797;"> Simulation, Multiplayer, Survival</h6></p>
              <a href="{{url('/farming')}}">
          ...
          <!--part2-->
            ...
            <div class="col-md-3">
                <div class="border border-dark" style="background-color: #353131; margin-top: 35px;">
                      <img src="Simulation/friday/friday1.jpg" style="width:300px">
                  </div>  
            ...
            <div class="col-md-4">
              <div class="card" style="background-color: #353131; margin-top: 35px;" >&nbsp;
              <p style="color: blanchedalmond; font-weight: 800;">Friday The 13TH</p>
              <p> <h6 style="font-size: small; color: #969797;"> Simulation, Multiplayer, Survival</h6></p>
              <a href="{{url('/friday')}}">
              <button style="background-color: #8FB4F4; font-weight: 800; margin-left: 60%; margin-top: 5%; font-size: small; width: 40%;">MORE</button>
              </a>
            ...
            <div class="col-md-3">
                <div class="border border-dark" style="background-color: #353131; margin-top: 35px;">
                      <img src="Simulation/planet/planet1.jpg" style="width:300px">
                  </div>  
            ...
            <div class="col-md-4">
              <div class="card" style="background-color: #353131; margin-top: 35px;" >&nbsp;
              <p style="color: blanchedalmond; font-weight: 800;">Planet Zoo</p>
              <p> <h6 style="font-size: small; color: #969797;"> Simulation, Multiplayer, Survival</h6></p>
              <a href="{{url('/planet')}}">
              <button style="background-color: #8FB4F4; font-weight: 800; margin-left: 60%; margin-top: 5%; font-size: small; width: 40%;">MORE</button>
              </a>
