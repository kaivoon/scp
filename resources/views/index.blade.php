       ...
       <div class="column">
         <div class="card">
           ...
           <div class="container">
             ...
             <p>MYR 219.00</p>
            <p><form action="{{url('/sekiro')}}"><button type="submit"class="button">More</button></form></p>
           </div>
         </div>
       </div>
       ...
       <div class="column">
         <div class="card">
           ...
           <div class="container">
              ...
              <p>MYR 139.00</p>
             <p><form action="{{url('/mhw')}}"><button type="submit"class="button">More</button></form></p>
           </div>
         </div>
       </div>
       <div class="column">
         <div class="card">
           ...
           <div class="container">
              ...
              <p>MYR 239.00</p>
             <p><form action="{{url('/death')}}"><button type="submit"class="button">More</button></form></p>
           </div>
         </div>
       </div>
            ...
            <div class="col-md-8">
              <div class="card border-0">
                <div class="row">
                  ...
                  <div class="col-md-6">
                      <h4 class="card-tittle">Grand Theft Auto V</h4>
                      <p> Grand Theft Auto V is an action-adventure video game developed by Rockstar North and published by Rockstar Games. Set within the fictional state of San Andreas, based on Southern California, the single-player story .....</p>
                      
                      <div style="height: 50px">
                      <form action="{{url('/gta')}}"><button type="submit"style="float:right" class="btn btn-danger btn-xs">More</button></form>
            ...
            <div class="col-md-8">
              <div class="card border-0">
                <div class="row">
                  ...
                  <div class="col-md-6">
                      <h4 class="card-tittle">Death Stranding</h4>
                      <p> Death Stranding is an action game set in an open world, and also includes asynchronous online functions .....</p>
                      
                      <div style="height: 50px">
                        <form action="{{url('/death')}}"><button type="submit"style="float:right" class="btn btn-danger btn-xs">More</button></form>
                    </div>
            ...
            <div class="col-md-8">
              <div class="card border-0">
                <div class="row">
                  ...
                  <div class="col-md-6">
                      <h4 class="card-tittle">Farm Simulator 19</h4>
                      <p> DFarming Simulator 19 was released on November 20, 2018. Some key new features include a redesigned graphics engine and the addition of horse farming as well as oat and cotton crops ......</p>
                      
                      <div style="height: 50px">
                        <form action="{{url('/farming')}}"><button type="submit"style="float:right" class="btn btn-danger btn-xs">More</button></form>
            ...
            <div class="col-md-8">
              <div class="card border-0">
                <div class="row">
                  ...
                  <div class="col-md-6">
                      <h4 class="card-tittle">Friday the 13th</h4>
                      <p> Friday the 13th is considered an unlucky day in Western superstition. It occurs when the 13th day of the month in the Gregorian calendar falls on a Friday .....</p>
                      
                      <div style="height: 50px">
                        <form action="{{url('/friday')}}"><button type="submit"style="float:right" class="btn btn-danger btn-xs">More</button></form>
              ...
              <div class="col-md-8">
                <div class="card border-0">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="card-tittle">Monster Hunter World</h4>
                        <p> Monster Hunter World is an action role-playing game developed and published by Capcom. A part of the Monster Hunter series .....</p>
