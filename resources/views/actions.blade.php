    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <a href="{{('index/')}}" style="color: black; font-size: small;">&#8918 back to store </a>
        ...
        <!--slideshow--> 
            ...
            <div class="col-md-8">
              <strong><h3 style= "text-align: center; font-size: xx-large; color: whitesmoke; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">~ Action Games ~</h3></strong>
              <h6 style="font-size: small; color: #969797; text-align: center;">Browse the newest, top selling and discounted Action products on SCP Games Shop</h6>
              ...
              <div class="container">
                  ...
                  <div class="mySlides">
                    ...
                    <a href="{{url('/death')}}">
                      <img src="Action/death/death.jpg" style="width:100%">
                    </a>
                  </div>
                  ...
                  <div class="mySlides">
                    ...
                    <a href="{{url('/mhw')}}">
                      <img src="Action/mhw/mhw.jpg" style="width:100%">
                    </a>
                  </div>
                  ...
                  <div class="mySlides">
                    ...
                    <a href="{{url('/sekiro')}}">
                      <img src="Action/sekiro/sekiro1.jpg" style="width:100%">
                    </a>
                  </div>
                  ...
                  <div style="margin-left: 33%;" >
                    <div class="column">
                      <img class="demo cursor" src="Action/death/death.jpg" style="width:100%" onclick="currentSlide(1)" alt="DEATH STRANDING">
                    </div>
                    <div class="column">
                      <img class="demo cursor" src="Action/mhw/mhw.jpg" style="width:100%" onclick="currentSlide(2)" alt="SEKIRO">
                    </div>
                    <div class="column">
                      <img class="demo cursor" src="Action/sekiro/sekiro1.jpg" style="width:100%" onclick="currentSlide(3)" alt="MONSTER HUNTER WORLD">
                    </div>
                  </div>
                </div>
          ...
          <!--part1-->
            ...
            <div class="col-md-3">
                ...
                <div class="border border-dark" style="background-color: #353131;">
                      <img src="Action/death/death.jpg" style="width:300px">
                  </div>  
            ...
            <div class="col-md-4">
              ...
              <p style="color: blanchedalmond; font-weight: 800;">DEATH STRANDING</p>
              <p> <h6 style="font-size: small; color: #969797;"> Action, Multiplayer, Survival</h6></p>
              <a href="{{url('/death')}}">
          ...
          <!--part2-->
            ...
            <div class="col-md-3">
                <div class="border border-dark" style="background-color: #353131; margin-top: 35px;">
                      <img src="Action/mhw/mhw.jpg" style="width:300px">
                  </div>  
            ...
            <div class="col-md-3">
                <div class="border border-dark" style="background-color: #353131; margin-top: 35px;">
                      <img src="Action/sekiro/sekiro2.jpg" style="width:300px">
                  </div>  
            ...
            <div class="col-md-4">
              <div class="card" style="background-color: #353131; margin-top: 35px;" >&nbsp;
              <p style="color: blanchedalmond; font-weight: 800;">SEkiro™: Shadows Die Twice</p>
              <p> <h6 style="font-size: small; color: #969797;"> Action, Multiplayer, Survival</h6></p>
              <a href="{{url('/sekiro')}}">
              <button style="background-color: #8FB4F4; font-weight: 800; margin-left: 60%; margin-top: 5%; font-size: small; width: 40%;">MORE</button>
              </a>
